...
There are a few dates and timestamps in this data. Don't worry about parsing this in the first round. We'll get to that in the next part of the exercise.
