...
Run the @rails -v@ command and you should see your current Rails version, mine is *3.0.9*. If Rails is not installed, run @sudo gem install rails@. You can check that it installed correctly by reviewing your @gem list@ and/or @rails -v@.
