...
* Look for the existing @stylesheet_link_tag@ line on line 5. Change it so it looks like this: @<%= stylesheet_link_tag 'styles' %>@. That tells Rails to pull a stylesheet names @styles.css@ from our stylesheets directory. Download that stylesheet ("styles.css":assets/jsmerchant/styles.css) and put it into your project's @/public/stylesheets/@ folder.
