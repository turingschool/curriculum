...
and map over the rating attributes.
...
The tests pass, but this is pretty dirty, and we will want a better solution
eventually, but for now this will let us connect the two applications.
